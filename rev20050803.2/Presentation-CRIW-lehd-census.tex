...
\usepackage[toc,hlsections,highlight,Census]{HA-prosper}
...
\overlays{3}{%
  ...
  \onSlide*{1}{\includegraphics[scale=0.31,angle=270]{overview-data-flow/overview-data-flow-extract-stage0}}
  \onSlide*{2}{\includegraphics[scale=0.31,angle=270]{overview-data-flow/overview-data-flow-extract-stage1}}
  \onSlide*{3}{\includegraphics[scale=0.31,angle=270]{overview-data-flow/overview-data-flow-extract-stage2}}
...
%  \onSlide*{6}{\includegraphics[scale=0.31,angle=270]{overview-data-flow/overview-data-flow-final}}
  \end{slide}
}
...
%  \onSlide*{1}{\includegraphics[scale=0.31,angle=270]{overview-data-flow/overview-data-flow-extract-stage0}}
%  \onSlide*{2}{\includegraphics[scale=0.31,angle=270]{overview-data-flow/overview-data-flow-extract-stage1}}
  \onSlide*{1}{\includegraphics[scale=0.31,angle=270]{overview-data-flow/overview-data-flow-extract-stage2}}
  \onSlide*{2}{\includegraphics[scale=0.31,angle=270]{overview-data-flow/overview-data-flow-extract-stage3}}
  \onSlide*{3}{\includegraphics[scale=0.31,angle=270]{overview-data-flow/overview-data-flow-extract-qwi}}
  \onSlide*{4}{\includegraphics[scale=0.31,angle=270]{overview-data-flow/overview-data-flow-final}}
  \end{slide}
}
